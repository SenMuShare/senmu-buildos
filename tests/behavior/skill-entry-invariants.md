...
| PR-14 | Product Reference 只维护文档职责、流转、冻结和回写；具体内容结构由对应模板承载。模板区分“必要内容（仅在已创建本文档时）”与“按需内容”，填写后删除提示和空章节 | `skills/senmu-build-product/SKILL.md`、`需求与产品迭代管理规范.md`、Product／Engineering 文档模板 |
